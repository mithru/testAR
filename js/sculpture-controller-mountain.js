AFRAME.registerComponent('sculpture-controller', {
  ...
  init() {
    ...
    setTimeout(() => {
      ...
      sculptureItem1.object3DMap.mesh.traverse(n => {
        if (n.isMesh) {
      ...
      sculptureItem6.object3DMap.mesh.traverse(n => {
        if (n.isMesh) {
          n.material.opacity = 1
          n.material.transparent = true
        }
    ...
    const parentPosString = '0 0 -16.5'
    const parentScaleString = '1.4 1.4 1.4'
    ...
    this.switchToConfig = () => {
      ...
      // sculptureParent.setAttribute('animation__pos', 'property: position; to: 0 -7 0; easing: easeInOutQuad; loop: false;delay:500 dur: 2500')
      sculptureParent.setAttribute('animation__pos', 'property: position; to: 0 0 -8; easing: easeInOutQuad; loop: false;delay:500 dur: 2500')
    ...
    this.transformAnimOver = () => {
      ...
      sculptureParent.setAttribute('animation__pos', 'property: position; to: 0 2 0; easing: easeInOutQuad; loop: false; delay:500; dur: 3000')
      sculptureParent.setAttribute('animation__rot', 'property: rotation; to: 0 5 0; easing: easeInOutQuad; loop: false; delay:500; dur: 3000')
      ...
      setTimeout(() => {
        ...
        sculptureItem1.setAttribute('visible', 'false');
        // sculptureItem5.setAttribute('visible', 'false');
        sculptureItem6.setAttribute('visible', 'false');
        sculptureItem7.setAttribute('visible', 'false');
      }, 500)

      setTimeout(() => {
        sculptureParent.setAttribute('animation__rot', 'property: rotation; dir:alternate; from: 0 5 0; to: 0 -5 0; easing: easeInOutQuad; loop: true; delay:0 dur: 5000;')
    ...
    this.zoomin = () => {
      sculptureParent.setAttribute('animation__pos', 'property: position; to: 0 2 0; easing: easeInOutQuad; loop: false; delay:0; dur: 1000')
      this.showtransform()
      pointer.addEventListener('click', this.switchToMV)
    }
    this.zoomout = () => {
      sculptureParent.setAttribute('animation__pos', 'property: position; to: 0 2 -5; easing: easeInOutQuad; loop: false; delay:0; dur: 1000')
      this.hidetransform()
    ...
    this.closeMV = () => {
      ...
      sculptureParent.setAttribute('animation__pos', 'property: position; to: 0 0 -5; easing: easeInOutQuad; loop: false; delay:0; dur: 1000')
      sculptureParent.setAttribute('animation__rot', 'property: rotation; to: 0 5 0; easing: easeInOutQuad; loop: false; delay:0; dur: 1000')
      setTimeout(() => {
        sculptureParent.setAttribute('animation__rot', 'property: rotation; dir:alternate; from: 0 5 0; to: 0 -5 0; easing: easeInOutQuad; loop: true; delay:0; dur: 5000;')
      }, 1200)
    ...
    this.switchToMV = () => {
      ...
      sculptureParent.setAttribute('drag-rotate-component', 'active:true; xRotAllowed:false; initScaleVal:0; ')
    ...
    this.reformToIdle = () => {
      ...
      sculptureParent.setAttribute('animation__pos', 'property: position; to: 0 -7 0; easing: easeInOutQuad; loop: false;delay:0 dur: 1500')
      ...
      setTimeout(() => {
        ...
        sculptureItem1.setAttribute('visible', 'true')
        // sculptureItem5.setAttribute('visible', 'true')
        sculptureItem6.setAttribute('visible', 'true')
