AFRAME.registerComponent('sculpture-controller', {
  ...
  init() {
    ...
    setTimeout(() => {
      ...
      sculptureItem3.object3DMap.mesh.traverse(n => {
        if (n.isMesh) {
          n.material.opacity = 1
          n.material.transparent = true
        }
    ...
    this.transformAnimOver = () => {
      ...
      sculptureParent.setAttribute('animation__pos', 'property: position; to: 0 0 0; easing: easeInOutQuad; loop: false; delay:500; dur: 3000')
      ...
      setTimeout(() => {
        ...
        sculptureItem3.setAttribute('visible', 'false');
    ...
    this.zoomin = () => {
      sculptureParent.setAttribute('animation__pos', 'property: position; to: 0 0 0; easing: easeInOutQuad; loop: false; delay:0; dur: 1000')
      this.showtransform()
    ...
    this.reformToIdle = () => {
      ...
      setTimeout(() => {
        ...
        sculptureItem3.setAttribute('visible', 'true')
