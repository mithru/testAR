...
function startExp() {
  ...
  setTimeout(() => {
    ...
    document.getElementById('sculpture-parent').setAttribute('animation__scale', 'property: scale; to: 1.4 1.4 1.4; easing: easeInOutQuad; loop: false; dur: 1000')
    document.getElementById('sculpture-parent').setAttribute('animation__pos', 'property: position; to: 0 0 -16.5; easing: easeInOutQuad; loop: false; dur: 2000')
  }, 14000) // 12000
}
